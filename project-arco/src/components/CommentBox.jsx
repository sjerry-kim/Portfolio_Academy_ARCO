    ...
    return (  
        <div>
          ...
          <div className="comment-box">
            ...
            <input type="text" onChange={(e)=>{setName(e.target.value)}} placeholder="Nickname"/>
            </div>
            <div className="text-box">
            <textarea type="text" onChange={(e)=>{setText(e.target.value)}} placeholder="Comment your review."/>
              ...
              {   
                memolist.map((memo, i)=>(
                  <div key={i} className="added-comment-inner-box">
                    ...
                    <p className="comment-date">{memo.year}.{memo.month<10? (`0${memo.month}`): memo.month}.{memo.date<10? (`0${memo.date}`):memo.date}</p>
                  </div>
                ))
              }
            </div>
